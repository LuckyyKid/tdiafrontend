...
const POSITION_SLUGS = ["media-buyer", "operations-engineer", "business-analyst", "executive-assistant"];
    ...
    <div className="min-h-screen flex flex-col text-white relative z-10">
      ...
      <div className="pt-32 md:pt-40 pb-16 px-4 md:px-8 container mx-auto relative halo-top">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="micro-label mb-6">{t('careerPage.microLabel')}</div>
      ...
      <div className="flex-grow container mx-auto px-4 md:px-8 pb-12">
        ...
        <div className="mb-16" id="open-positions">
          <div className="text-center mb-10">
            <h2 className="tdia-h text-[28px] md:text-[40px]">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {positionsArray.map((position, index) => {
              const slug = POSITION_SLUGS[index];
              return (
                <div key={slug ?? index} className="tdia-card p-6 md:p-8">
        ...
        <div className="mb-16 max-w-4xl mx-auto" id="general-application">
          <div className="tdia-card p-8 md:p-10 halo-cta">
            <div className="text-center mb-8">
              ...
              <p className="text-[#7c8aa5] max-w-2xl mx-auto">
                {t('careerPage.generalApplication.description')}
              </p>
            </div>
            <div className="max-w-xl mx-auto">
              <JobApplicationForm position={t('careerPage.generalApplication.title')} />
            </div>
          </div>
        </div>
      </div>
